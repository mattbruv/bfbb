...
typedef int(*type_6)(xGoal*, void*, float, void*);
typedef int(*type_7)(xGoal*, void*, float, void*);
typedef int(*type_8)(xGoal*, void*, float, void*);
typedef int(*type_9)(xGoal*, void*, xBase*, xBase*, unsigned int, float*, xBase*, int*);
typedef int(*type_10)(xGoal*, void*, en_trantype*, float, void*);
typedef int(*type_11)(xGoal*, void*, en_trantype*, float, void*);
...
int SysEvent(xGoalGeneric* this, xBase* from, xBase* to, unsigned int toEvent, float* toParam, xBase* toParamWidget, int* handled);
int Resume(xGoalGeneric* this, float dt, void* updCtxt);
int Suspend(xGoalGeneric* this, float dt, void* updCtxt);
int Exit(xGoalGeneric* this, float dt, void* updCtxt);
int Enter(xGoalGeneric* this, float dt, void* updCtxt);
void GOALDestroy_Generic(xFactoryInst* item);
xFactoryInst* GOALCreate_Generic(int who, RyzMemGrow* growCtxt);
