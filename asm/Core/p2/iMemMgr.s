...
/* 800C6378 000C3178  93 ED 92 20 */	stw r31, lbl_he-_SDA_BASE_(r13)
...
/* 800C6390 000C3190  90 6D 92 1C */	stw r3, lbl_hs-_SDA_BASE_(r13)
/* 800C6394 000C3194  48 10 BB F5 */	bl func_801D1F88
/* 800C6398 000C3198  80 8D 92 20 */	lwz r4, lbl_he-_SDA_BASE_(r13)
/* 800C639C 000C319C  48 10 BC 5D */	bl func_801D1FF8
/* 800C63A0 000C31A0  90 6D 92 18 */	stw r3, lbl_the_heap-_SDA_BASE_(r13)
/* 800C63A4 000C31A4  80 6D 92 18 */	lwz r3, lbl_the_heap-_SDA_BASE_(r13)
...
/* 800C63C8 000C31C8  3C E0 80 39 */	lis r7, lbl_gMemInfo@ha
/* 800C63CC 000C31CC  39 40 00 00 */	li r10, 0
/* 800C63D0 000C31D0  39 27 C3 20 */	addi r9, r7, lbl_gMemInfo@l
...
/* 800C640C 000C320C  90 8D 92 24 */	stw r4, lbl_HeapSize-_SDA_BASE_(r13)
/* 800C6410 000C3210  80 6D 86 40 */	lwz r3, lbl_803CAF40-_SDA_BASE_(r13)
/* 800C6414 000C3214  48 10 B9 ED */	bl func_801D1E00
/* 800C6418 000C3218  90 6D 92 14 */	stw r3, lbl_mem_base_alloc-_SDA_BASE_(r13)
/* 800C641C 000C321C  3C 80 80 39 */	lis r4, lbl_gMemInfo@ha
/* 800C6420 000C3220  38 E4 C3 20 */	addi r7, r4, lbl_gMemInfo@l
/* 800C6424 000C3224  38 C0 08 20 */	li r6, 0x820
/* 800C6428 000C3228  81 2D 92 24 */	lwz r9, lbl_HeapSize-_SDA_BASE_(r13)
...
/* 800C643C 000C323C  91 0D 92 10 */	stw r8, lbl_mem_top_alloc-_SDA_BASE_(r13)
...
/* 800C6474 000C3274  3C 60 80 39 */	lis r3, lbl_gMemInfo@ha
/* 800C6478 000C3278  90 01 00 14 */	stw r0, 0x14(r1)
/* 800C647C 000C327C  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800C6480 000C3280  3B E3 C3 20 */	addi r31, r3, lbl_gMemInfo@l
